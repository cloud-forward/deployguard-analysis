...
# DISABLED: OpenSearch client import - commenting out to ensure clean startup
# try:
...
class OpenSearchRiskResultRepository(RiskResultRepository):
    """
    TEMPORARILY DISABLED: This repository is not functional until OpenSearch is configured.
    """
    ...
    async def persist_score(self, target_id: str, score: float) -> None:
        ...
        # DISABLED: Returns None until OpenSearch is available
        return None
