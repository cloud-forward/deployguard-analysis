...
RDS_HOST_KEYS = frozenset({"host", "endpoint", "db_host"})
RDS_USERNAME_KEYS = frozenset({"username", "user", "db_user"})
RDS_PASSWORD_KEYS = frozenset({"password", "passwd", "db_password"})
RDS_PORT_KEYS = frozenset({"port", "db_port"})
